(function () {
    ...
    function compare() {
        ...
        switch (rightNumbers) {
            case 1:
                message.value = "trafiłeś 1 liczbę";
                count1++;
                break;
            case 2:
                message.value = "trafiłeś dwójkę";
                count2++;
                break;
            case 3:
                message.value = "trafiłeś trójkę";
                cash += 15;
                count3++;
                break;
            case 4:
                message.value = "trafiłeś czwórkę";
                cash += 300;
                count4++;
                break;
            case 5:
                message.value = "trafiłeś piątkę";
                cash += 5000;
                count5++;
                break;
            case 6:
                message.value = "Gratulację! Wygrałeś główną nagrodę!";
                cash += 2000000;
                count6++;
                break;
            default:
                message.value = "Niestety nic nie trafiłeś!";
                break;
        }
    ...
    function goOut() {
        ...
        setTimeout(function () {
            visible.nextElementSibling.classList.add("visible", "animateIn")
        }, 600);
